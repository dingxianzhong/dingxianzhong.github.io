...
<ul style="font-size:16px;">
  ...
  <li><strong><a href="https://dingxianzhong.github.io/VMR2Lhomepage/">VMR²L: Reinforcement Learning for Virtual Machine Rescheduling</a></strong> — RL-based VM rescheduling under a strict 5-second latency budget; two-stage sparse-attention actor achieving 97.1% of optimal MIP quality and reducing inference from 50.5 min → 1.1 s on large-scale clusters (280–1176 PMs, 2000–4500 VMs). <a href="https://mp.weixin.qq.com/s/qrj8AKwrpEUWUQgi6yiC8Q" style="color:red;"><strong>Media (CN)</strong></a></li>

  <li><strong><a href="https://github.com/dingxianzhong/HPC-GPT">HPC-GPT</a></strong> — Developed the first open-source HPC-tuned LLM (based on LLaMA-13B) via automated instruction generation and supervised fine-tuning; integrated domain knowledge for data-race detection and HPC analysis; achieved 21% accuracy improvement over GPT-4 and released public datasets and model weights.</li>
</ul>
